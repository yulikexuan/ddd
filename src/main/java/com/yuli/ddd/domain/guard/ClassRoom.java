...
public class ClassRoom {
     ...
     */
    public void subscribeImproved(User user, Subscription subscription, Term term) {
     ...
     */
    public void subscribeImprovedAgain(@NonNull User user, @NonNull Subscription subscription, @NonNull Term term) {
     ...
     */
    public void subscribeAdvance(@NonNull User user, @NonNull Subscription subscription, @NonNull Term term) {
