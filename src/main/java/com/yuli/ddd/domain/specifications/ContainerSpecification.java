...
public class ContainerSpecification implements ISpecification<Container> {
    ...
    private final EnumSet<ContainerFeature> requiredFeatures = EnumSet.noneOf(ContainerFeature.class);

    public static ContainerSpecification create(@NonNull ContainerFeature... feature) {
