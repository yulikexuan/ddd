...
public final class StockPaint implements IPaint {
	...
	private StockPaint(double volume, PigmentColor color) {
		this.volume = volume;
		this.color = PigmentColor.builder()
				.setRed(color.getRed())
				.setBlue(color.getBlue())
				.setYellow(color.getYellow())
				.createPigmentColor();
	}
	...
	public PigmentColor getColor() {
		return PigmentColor.builder()
				.setRed(this.color.getRed())
				.setYellow(this.color.getYellow())
				.setBlue(this.color.getBlue())
				.createPigmentColor();
	}
